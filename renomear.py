...
def extrair_nome_bloco(caminho_pdf):
    with open(caminho_pdf, 'rb') as pdf_file:
        ...
        # Expressão regular para encontrar padrões de nome do cliente
        padrao_nome_bloco = r"Tipo: Cotanº.:\s*(\w+\s+\w+\s+\w+)"
        ...
        if match:
            ...
            if match:
                ...
                return None
diretorio = R'W:\ARQUIVOS-GNA\PUBLICA\Pub. Coordenação SALA\CONTRAKTOR\Vigente_\arquivozip\0023'
