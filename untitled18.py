# -*- coding: utf-8 -*-
"""
Created on Wed Jun  7 14:27:22 2023
...
def buscar_padrao1(texto1, textp):
...
caminho_pdf = R'C:\Users\gabriel.rodrigues\Desktop\teste 2\exclsuive\bloco 1\apartamento 1\cota 1\ok2.pdf'
page_number = 1
convert_page_to_jpg()
...
if texto_extraido: 
    ...
    page_number = 1
    texto_extraido2 = convert_page_to_jpg()
