...
def verificar_correspondencia(elemento, numero):
    ...
    if images:
        while i < quantidade_paginas:
            ...
            if i > 10 and indicador2 == 0 and indicador3 == 0:
...
df = pd.read_excel(R'C:\Users\gabriel.rodrigues\Desktop\lista_clientes_arquivar.xlsx')
df2 = pd.read_excel(R'C:\Users\gabriel.rodrigues\Desktop\lista_caminhos.xlsx')
...
for i in range(0, len(nova_lista2), 2):
    ...
    if elemento_buscado:
        ...
        df2.to_excel(R'C:\Users\gabriel.rodrigues\Desktop\lista_caminhos.xlsx', index=False)
